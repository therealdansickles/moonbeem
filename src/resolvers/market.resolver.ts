...
export class MarketResolver {
    ...
    async getAddressHoldings(
        @Context('req') req: any,
        @Args() args: VAddressHoldingReqDto
    ): Promise<VAddressHoldingRspDto> {
    ...
    public async getAddressActivities(
        @Context('req') req: any,
        @Args() args: MarketAddressActivitiesReqDto
    ): Promise<MarketAddressActivitiesRspDto> {
    ...
    async getAddressReleased(
        @Context('req') req: any,
        @Args() args: MarketAddressReleasedReqDto
    ): Promise<MarketAddressReleasedRspDto> {
    ...
    public async getCollectionActivities(
        @Context('req') req: any,
        @Args() args: VCollectionActivityReqDto
    ): Promise<VCollectionActivityRspDto> {
