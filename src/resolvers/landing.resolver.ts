...
export class LandingResolver {
    ...
    async getLandingPageCollections(
        ...
        @Args() args: LandingPageCollectionReqDto
    ): Promise<LandingPageCollectionRspDto> {
    ...
    async getRankingOfCreators(
        @Context('req') req: unknown,
        @Args() args: LandingPageRankingOfCreatorsReqDto
    ): Promise<LandingPageRankingOfCreatorsRspDto> {
    ...
    async getRankingOfItems(
        @Context('req') req: unknown,
        @Args() args: LandingPageRankingOfItemsReqDto
    ): Promise<LandingPageRankingOfItemsRspDto> {
