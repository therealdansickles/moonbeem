...
import {
    AttributeOverviewInput, CreateTierInput, DeleteTierInput, IOverview, Profit, Tier,
    TierSearchInput, TierSearchPaginated, UpdateTierInput
} from './tier.dto';
...
export class TierResolver {
    ...
    async tiers(
        ...
        const query: ITierQuery = { name, pluginName };
