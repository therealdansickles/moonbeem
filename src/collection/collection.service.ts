...
export class CollectionService {
    ...
    async createMintSaleContract(
        ...
        return await this.mintSaleContractRepository.save({
            ...
            price: collectionMetadata.openSeaMetadata?.floorPrice?.toString() || '0',
    ...
    async createMigrationCollectionAndTier(
        ...
        const createCollectionInput: CreateCollectionInput = {
            ...
            organization,
            displayName: collectionMetadata.openSeaMetadata?.collectionName,
            about: collectionMetadata.openSeaMetadata?.description,
            address: collectionMetadata.address,
            tokenAddress: collectionMetadata.address,
            avatarUrl: collectionMetadata.openSeaMetadata?.imageUrl,
            backgroundUrl: collectionMetadata.openSeaMetadata.imageBannerUrl,
            websiteUrl: collectionMetadata.openSeaMetadata?.externalUrl,
            twitter: collectionMetadata.openSeaMetadata?.twitterUsername,
            discord: collectionMetadata.openSeaMetadata?.discordUrl,
            collaboration,
            creator: owner,
            ...
            tiers: [
                {
                    ...
                    image: collectionMetadata.openSeaMetadata?.imageUrl,
