...
export class LandingController {
    ...
    public async getLandingPageCollections(
        @Req() req: Request,
        @Query() args: LandingPageCollectionReqDto
    ): Promise<IResponse> {
        try {
    ...
    public async getRankingOfCreators(
        @Req() req: Request,
        @Query() args: LandingPageRankingOfCreatorsReqDto
    ): Promise<IResponse> {
        try {
    ...
    public async getRankingOfItems(
        @Req() req: Request,
        @Query() args: LandingPageRankingOfItemsReqDto
    ): Promise<IResponse> {
        try {
